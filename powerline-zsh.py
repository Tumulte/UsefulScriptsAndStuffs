...
def add_uname(powerline):
    uname = os.getenv('USER')
    bg = Color.USER_BG
    fg = Color.USER_FG
    powerline.append(Segment(powerline, ' %s ' %  uname, fg, bg))
    return True
...
def add_root_indicator(powerline, error):
    ...
    unicode_list = ['\u2699', '\u262D', '\u265c', '\u2623', '\u262c', '\u2620', '\u262f', '\u2694']
    index = randint(0,7)
    powerline.append(Segment(powerline, ' '+unicode_list[index], fg, bg))
